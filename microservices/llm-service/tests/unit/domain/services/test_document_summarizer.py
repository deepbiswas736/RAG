...
class TestDocumentSummarizer:
    """Test cases for the DocumentSummarizer class"""
...
"""  # Missing closing brace
        ...
        assert result["category"] != "unknown"  # Should extract from text    def test_parse_document_summary_with_malformed_json(self, document_summarizer):
